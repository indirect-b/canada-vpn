...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v4, v1, v3}, Lj$/time/chrono/y;-><init>(ILj$/time/i;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5, v3}, Lj$/time/i;->f0(III)Lj$/time/i;
    ...
    invoke-direct {v1, v4, v3, v5}, Lj$/time/chrono/y;-><init>(ILj$/time/i;Ljava/lang/String;)V
    ...
    invoke-static {v6, v7, v5}, Lj$/time/i;->f0(III)Lj$/time/i;

    move-result-object v5

    const-string v6, "Showa"

    invoke-direct {v3, v2, v5, v6}, Lj$/time/chrono/y;-><init>(ILj$/time/i;Ljava/lang/String;)V
    ...
    invoke-static {v6, v2, v7}, Lj$/time/i;->f0(III)Lj$/time/i;
    ...
    invoke-direct {v5, v7, v6, v8}, Lj$/time/chrono/y;-><init>(ILj$/time/i;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v2}, Lj$/time/i;->f0(III)Lj$/time/i;
    ...
    invoke-direct {v6, v10, v8, v11}, Lj$/time/chrono/y;-><init>(ILj$/time/i;Ljava/lang/String;)V
...
.method private constructor <init>(ILj$/time/i;Ljava/lang/String;)V
    ...
    .line 257
    iput-object p2, p0, Lj$/time/chrono/y;->b:Lj$/time/i;
...
.method public static A()[Lj$/time/chrono/y;
    .locals 2
...
.method static q(Lj$/time/i;)Lj$/time/chrono/y;
    .locals 4

    .line 368
    sget-object v0, Lj$/time/chrono/x;->d:Lj$/time/i;

    invoke-virtual {p0, v0}, Lj$/time/i;->b0(Lj$/time/i;)Z
    ...
    .line 373
    iget-object v3, v2, Lj$/time/chrono/y;->b:Lj$/time/i;

    invoke-virtual {p0, v3}, Lj$/time/i;->V(Lj$/time/chrono/b;)I
...
.method static x()J
    ...
    invoke-virtual {v0}, Lj$/time/temporal/a;->C()Lj$/time/temporal/x;

    move-result-object v0

    invoke-virtual {v0}, Lj$/time/temporal/x;->f()J
    ...
    .line 228
    iget-object v6, v5, Lj$/time/chrono/y;->b:Lj$/time/i;

    .line 890
    invoke-virtual {v6}, Lj$/time/i;->c0()Z
    ...
    .line 228
    :goto_1
    iget-object v7, v5, Lj$/time/chrono/y;->b:Lj$/time/i;
    ...
    iget-object v5, v5, Lj$/time/chrono/y;->b:Lj$/time/i;
...
.method static y()J
    ...
    iget-object v0, v0, Lj$/time/chrono/y;->b:Lj$/time/i;
    ...
    invoke-virtual {v6}, Lj$/time/i;->a0()I
    ...
    .line 214
    iget-object v0, v5, Lj$/time/chrono/y;->b:Lj$/time/i;
...
.method public final l(Lj$/time/temporal/s;)Lj$/time/temporal/x;
    ...
    invoke-virtual {p1, v0}, Lj$/time/chrono/v;->U(Lj$/time/temporal/a;)Lj$/time/temporal/x;
    ...
    .line 456
    :cond_0
    invoke-super {p0, p1}, Lj$/time/chrono/m;->l(Lj$/time/temporal/s;)Lj$/time/temporal/x;
...
.method final s()Lj$/time/i;
    .locals 1

    .line 272
    iget-object v0, p0, Lj$/time/chrono/y;->b:Lj$/time/i;

    return-object v0
.end method

.method final t()Lj$/time/chrono/y;
    .locals 1
